...
let pulsacionesSorteo = 0;
let temporizadorPulsaciones;


// Detectar pulsaciones sobre la X

accesoSorteo.addEventListener("click", () => {

    pulsacionesSorteo++;


    // Reiniciar el contador si pasa demasiado tiempo

    clearTimeout(temporizadorPulsaciones);

    temporizadorPulsaciones = setTimeout(() => {
    ...
    // Abrir sorteo después de 5 pulsaciones

    if(pulsacionesSorteo >= 5){
